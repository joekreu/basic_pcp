...
powers and token insertion is not a goal of this project.
...
```
 ...
 > _Note 2:_ Only the iterative parsers (see 3.1) explicitely reference the
 > `$BEGIN` token.
...
> assigned to an operator. The parsers in this repo are _precedence parsers_
